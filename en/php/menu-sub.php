    ...
    <section class="section section-default mt-0 mb-0 border-0 bg-color-dark-scale-6">
        <div class="row text-center">
            <div class="col">
                ...
                <a class="text-color-light" href="account_seats.phtml"><button class="btn btn-sm btn-rounded ' . (str_starts_with($caller, "account_seats.phtml") ? 'btn-primary' : 'btn-light') . ' btn-modern text-3 mt-1">Seats</button></a>
                <div class="btn-group">
                ...
                <a class="text-color-light" href="account_featurerequest.phtml"><button class="btn btn-sm ' . (str_starts_with($caller, "account_featurerequest.phtml") ? 'btn-primary' : 'btn-light') . ' btn-modern btn-rounded text-3 mt-1">Feature request</button></a>
                <a class="text-color-light" href="account_bugreport.phtml"><button class="btn btn-sm ' . (str_starts_with($caller, "account_bugreport.phtml") ? 'btn-primary' : 'btn-light') . ' btn-modern btn-rounded text-3 mt-1">Bug Report</button></a>                
