...
echo '
        ...
        <div class="gdpr-bar" data-plugin-gdpr>
            <div class="gdpr-bar-description">
                <p class="text-color-light opacity-7 mb-0">Wir verwenden Cookies, um die Benutzerfreundlichkeit zu verbessern und den Websiteverkehr zu analysieren. Lesen Sie, wie wir Cookies verwenden und wie Sie sie kontrollieren können, indem Sie auf "Datenschutzeinstellungen" klicken.</p>
            </div>
                ...
                <form class="gdpr-preferences-form">
                    <div class="gdpr-preferences-popup-content-body">
                        ...
                        <div class="gdpr-cookie-item">
                            ...
                            <div class="gdpr-cookie-item-description">
                                <p class="mb-0">Aus Gründen der Leistung und Sicherheit verwenden wir Cloudflare als unserCDN-Netzwerk.</p>
                            </div>
                            <div class="gdpr-cookie-item-action">
                                <strong class="text-color-dark text-2">ERFORDERLICH</strong>
                        ...
                        <div class="gdpr-cookie-item">
                            ...
                            <div class="gdpr-cookie-item-description">
                                <p class="mb-0">Wir verwenden denYouTube-Dienst, um das Streaming von Videoinhalten auf dieser Website zu ermöglichen.</p>
                            </div>
                            <div class="gdpr-cookie-item-action">
                        ...
                        <div class="gdpr-cookie-item">
                            ...
                            <div class="gdpr-cookie-item-description">
                                <p class="mb-0">Wir verwenden den DienstVimeo, um das Streaming von Videoinhalten auf dieser Website zu ermöglichen.</p>
                            </div>
                            <div class="gdpr-cookie-item-action">
